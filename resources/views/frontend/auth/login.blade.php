                    ...
                    <x-slot name="body">
                        ...
                        <x-forms.post :action="route('frontend.auth.login')">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="email" id="email" class="form-control" placeholder="{{ __('E-mail Address') }}" value="{{ old('email') }}" maxlength="255" autofocus autocomplete="email" />
                                </div>
                            </div><!--form-group-->
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-8 offset-md-4">
                                    <button class="btn btn-primary btn_submit" type="submit">@lang('Login')</button>
                                </div>
                            </div><!--form-group-->
